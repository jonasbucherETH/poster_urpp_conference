...
title: '<span class="brsmall"></span> Methylator - DNA methylation pipeline<br>for plants and mammals'
...
Various tools have been introduced to facilitate the analysis of DNA methylation data. Usually, they focus on a small part of the workflow, which still leaves users with a considerable amount of work to evaluate appropriate tools, transform intermediate output, and finally generate presentable figures. Additionally, many tools are limited in terms of the input data, only providing support for certain species and/or sequencing methods.
...
<figure>
<center>
  <img src="figures/dotPlot_full2.png" width="100%" style="display:block">
  <br>
