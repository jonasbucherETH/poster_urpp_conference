...
main_bottomsize: 0.1
#ESSENTIALS
title: '**Pipeline for DNA Methylation Data Analysis: Addressing the Genomics Reproducibility Crisis**'
author:
  - name: '**Jonas Bucher**'
    affil: 1
    main: true
...
affiliation:
  - num: 1
    address: Department of Plant and Microbial Biology, University of Zurich
  - num: 2
    address: Department of Graphics and Layouts, University of Posters; Canada

main_findings:
  - "GUI, shiny, publication ready figures, documentation, export, mammals & plants"
logoleft_name: "https://github.com/jonasbucherETH/poster_urpp_conference/tree/main/logos/uzh_logo_e_pos_web_main.jpeg"
